if(retoRealizar == 3 || retoRealizar == 5 || retoRealizar == 7){
    ...
    var figuras = new Array("1", "2", "3" );
    if(nivel == 1) 
    {
        var numerofiguras = new Array("4", "3", "3" );
    }
    else if(nivel == 2) 
    {
        var numerofiguras = new Array("5", "4", "4" );
    }
    else
    {
        var numerofiguras = new Array("6", "5", "5" );
    }

    var frases = new Array("Seleccione los cubos.", "Seleccione las pirámides.", "Seleccione las esferas." );
